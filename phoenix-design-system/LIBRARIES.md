...
| **countup** | Animowane liczniki (dashboardy) | `react-countup` | `npm i react-countup` | 🟡 Średni |
...
| **tinymce** | Rich text editor (WYSIWYG) — zastąpiony przez **TipTap** | `@tiptap/react` | `npm i @tiptap/react @tiptap/starter-kit` | 🔴 Wysoki |
...
# Rich text (TipTap zamiast TinyMCE)
...
| 🟡 **Średni** (przy budowie modułów) | react-datepicker, react-leaflet, dayjs, simplebar-react |
